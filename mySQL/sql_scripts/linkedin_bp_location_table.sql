...
CREATE TABLE `location_table` (
  ...
  `location(country_code)` tinytext,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Location_Table_Basic_Profile_idx` (`Basic_Profile_local id`,`Basic_Profile_id`),
  CONSTRAINT `fk_Location_Table_Basic_Profile` FOREIGN KEY (`Basic_Profile_local id`, `Basic_Profile_id`) REFERENCES `basic_profile` (`local id`, `id`)
